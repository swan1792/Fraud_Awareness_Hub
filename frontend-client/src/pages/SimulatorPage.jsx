        ...
        <section className="relative overflow-hidden text-red-950">
          <div className="relative mx-auto flex max-w-6xl flex-col gap-3 px-4 pt-28 pb-12 md:pt-32 md:pb-20">
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:gap-10">
              <div className="flex items-start gap-3 rounded-xl p-4 border-2 border-red-500/55 bg-red-500/20 shadow-lg backdrop-blur-3xl backdrop-saturate-150">
                <AlertTriangle className="size-8 sm:size-10 text-red-500 mt-0.5 shrink-0" />
                <div className="min-w-0 flex-1">
                  <h2 className="font-semibold text-lg sm:text-xl text-red-500">{t("simulator.neverShare")}</h2>
              ...
              <div className="flex items-start gap-3 rounded-xl p-4 border-2 border-green-500/55 bg-green-500/20 shadow-lg backdrop-blur-3xl backdrop-saturate-150">
                <ShieldCheck className="size-8 sm:size-10 text-green-500 mt-0.5 shrink-0" />
                <div className="min-w-0 flex-1">
                  <h2 className="font-semibold text-lg sm:text-xl text-green-500">{t("simulator.verifyFirst")}</h2>
                  <p className="text-slate-300 mt-1 text-sm">
